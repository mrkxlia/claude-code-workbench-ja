...
- **model-setup**（旧名 sonnet-setup） — 導入すると `/task-brief`（着手前にタスク仕様を一括
  ...
  [model-setup/README.md](plugins/model-setup/) を参照。
...
mkdir -p ~/.claude/skills && cp -r /tmp/workbench/plugins/software-pipeline/.claude/skills/pipeline-setup ~/.claude/skills/

# task-pipeline — task-pipeline-setup をパーソナルスキル化
mkdir -p ~/.claude/skills && cp -r /tmp/workbench/plugins/task-pipeline/.claude/skills/task-pipeline-setup ~/.claude/skills/
...
mkdir -p .claude/skills .claude/agents && cp -r /tmp/workbench/plugins/codex-bridge/.claude/skills/* .claude/skills/ && cp -r /tmp/workbench/plugins/codex-bridge/.claude/agents/* .claude/agents/
...
cp -r /tmp/workbench/plugins/model-setup/.claude/skills/task-brief /tmp/workbench/plugins/model-setup/.claude/skills/backlog-loop \
      /tmp/workbench/plugins/model-setup/.claude/skills/fan-out /tmp/workbench/plugins/model-setup/.claude/skills/long-run \
      /tmp/workbench/plugins/model-setup/.claude/skills/verify-fresh ~/.claude/skills/
mkdir -p ~/.claude/agents && cp -r /tmp/workbench/plugins/model-setup/.claude/agents/* ~/.claude/agents/
```
