<!-- GENERATED by multi-model-dist — DO NOT EDIT. source: templates/data-science/.claude/skills/visualization/SKILL.md -->
---
name: visualization
description: チャートの作成、既存の matplotlib/seaborn コードの改善、レポートやダッシュボード用の図表保存時に参照するスキル。「グラフを描いて」「可視化して」「図を保存して」といった依頼で発動する。
---
# visualization
